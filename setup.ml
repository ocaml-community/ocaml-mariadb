...
(* OASIS_START *)
(* DO NOT EDIT (digest: abf70c6d4775afcfa0dfe709ae4f5624) *)
(*
...
let setup_t =
  {
                        ...
                        [
                           (OASISExpr.EBool true,
                             [
                                "-I";
                                "${pkg_ctypes_stubs}";
                                "${mariadb_config_cflags}"
                             ])
                        ];
                      bs_cclib =
                        [(OASISExpr.EBool true, ["${mariadb_config_libs}"])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt =
                        [(OASISExpr.EBool true, ["-warn-error"; "+1..45"])];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_findlib_extra_files = [];
                      bs_ccopt =
                        [(OASISExpr.EBool true, ["${mariadb_config_cflags}"])
                        ];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
     ...
     oasis_digest = Some "J{\162\226P&\004\158o\144\\\208{\174D\203";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
