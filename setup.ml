...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9ae9011d9fbcab1d65b7ee4c8d966f14) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          categories = [];
          files_ab =
            ["stubgen/ffi_stubgen.ml.ab"; "stubgen/ffi_types_stubgen.ml.ab"];
          sections =
            [
               Flag
                 ({
                     cs_name = "mariadb_connector";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      flag_description =
                        Some "Link to the MariaDB C/Connector library";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                     cs_name = "mariadb_as_mysql";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      flag_description =
                        Some
                          "MariaDB's libmariadbclient installed as libmysqlclient.so";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                     cs_name = "mariadb_bindings";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "mariadb_bindings";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "mariadb_bindings"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "OCaml-MariaDB documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/select";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "mariadb";
                           FindlibPackage ("unix", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "nonblocking_select_example.ml"
                   });
               Executable
                 ({
                     cs_name = "nonblocking_select_stress_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "nonblocking_select_stress_test.ml"
                   });
               Flag
                 ({
                     cs_name = "lwt";
                   ...
                   {
                      flag_description = Some "Build the Lwt example";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Executable
                 ({
                     cs_name = "nonblocking_lwt";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "nonblocking_lwt_example.ml"
                   });
               Executable
                 ({
                     cs_name = "nonblocking_lwt_stress_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "nonblocking_lwt_stress_test.ml"
                   });
               Flag
                 ({
                     cs_name = "async";
                   ...
                   {
                      flag_description = Some "Build the Async example";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Executable
                 ({
                     cs_name = "nonblocking_async";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "nonblocking_async_example.ml"
                   });
               Executable
                 ({
                     cs_name = "nonblocking_async_stress_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "nonblocking_async_stress_test.ml"
                   });
               Executable
                 ({
                     cs_name = "blocking";
                  ...
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/blocking";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "mariadb"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "blocking_example.ml"
                   });
               Executable
                 ({
                     cs_name = "blocking_stress_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "blocking_stress_test.ml"
                   });
               Executable
                 ({
                     cs_name = "nonblocking_stress_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "nonblocking_stress_test.ml"
                   })
            ];
     ...
     oasis_digest = Some "}\159\137L!\155\229\240KZm\r\210\205\192e";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
