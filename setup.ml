...
(* OASIS_START *)
(* DO NOT EDIT (digest: d0c68f4a526368f94301b97489ffa6e3) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          sections =
            [
               ...
               Executable
                 ({
                     cs_name = "test_nonblocking_select";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "test_nonblocking_select.ml"
                   });
               Flag
                 ({
                     cs_name = "lwt";
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "test_nonblocking_lwt.ml"
                   });
               Flag
                 ({
                     cs_name = "async";
               ...
               Executable
                 ({
                     cs_name = "test_nonblocking_async";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "test_nonblocking_async.ml"
                   });
               Executable
                 ({
                     cs_name = "test_blocking";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "test_blocking.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\201\234<V \133\248\221\026\r\134M\1790\158l";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
