...
(* OASIS_START *)
(* DO NOT EDIT (digest: 65157416f33ee1c61bfb3af9df5f62f3) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Mariadb_nonblocking"];
                      lib_pack = false;
                      lib_internal_modules =
                        [
                           "Common";
                      ...
                      lib_findlib_parent = Some "mariadb";
                      lib_findlib_name = Some "nonblocking";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
               ...
               Executable
                 ({
                     cs_name = "test_nonblocking_functor";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "test_nonblocking_functor.ml"
                   });
               Executable
                 ({
                     cs_name = "test_blocking_functor";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "test_blocking_functor.ml"
                   })
            ];
          plugins =
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "Q4b\254\174(\022\176\236\222\253\247 \164o\027";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
