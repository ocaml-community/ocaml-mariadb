(* OASIS_START *)
(* DO NOT EDIT (digest: 7011cb26a56db26fc749ec61ecb76f13) *)
...
let package_default =
  {
     ...
     flags =
       [
          ...
          ([
              "oasis_library_mariadb_bindings_native";
              "ocaml";
              "link";
              "native"
           ],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          ([
              "oasis_library_mariadb_bindings_byte";
              "ocaml";
              "ocamldep";
              "byte"
           ],
          ...
          ([
            ...
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_library_mariadb_bindings_byte"; "ocaml"; "compile"; "byte"
           ],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          ([
              "oasis_library_mariadb_bindings_native";
          ...
          (["oasis_library_mariadb_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_library_mariadb_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          (["oasis_library_mariadb_native"; "ocaml"; "ocamldep"; "native"],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          ...
          ([
            ...
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          ([
              "oasis_executable_nonblocking_stress_test_byte";
              "ocaml";
              "link";
              "byte"
           ],
            [(OASISExpr.EBool true, S [A "-warn-error"; A "+1..45"])]);
          ([
              "oasis_executable_nonblocking_stress_test_native";
              "ocaml";
              "link";
              "native"
           ],
...
let dispatch = function
  | After_rules ->
    ...
    Pathname.define_context "examples/select" ["examples/nonblocking"]
